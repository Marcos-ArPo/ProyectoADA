...
public class VisResNor extends javax.swing.JFrame {
    ...
    public VisResNor(String matricula) {
        initComponents();
        ...
        dateFecha.setMinSelectableDate(new Date());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RESERVA DE PLAZA - NORMAL");
    ...
    private void btnReservarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReservarActionPerformed
        ...
        try {
            ...
            controlador.hacerReserva(dateFecha.getDate(), horaIni, horaFin);
